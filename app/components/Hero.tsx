...
return (
    ...
    <section className="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
        <div className="absolute my-6 inset-x-0 bottom-0 z-10 hidden lg:flex">
            <BookCard
            
            title="XYZ Book"    
            url="/book1.jpg"
            className="-rotate-[0.442rad]"/>
          
          <BookCard
            
            title="XYZ Book"
            url="/book2.jpg"
            className="-rotate-[0.142rad]"/>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div className="max-w-xl mx-auto text-center">
                <h1 className="text-4xl font-bold sm:text-6xl">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Together, we fund stories and knowledge. </span>
                </h1>
                <p className="mt-5 text-base text-white sm:text-xl">Create a campaign, support a reader, and make books accessible for everyone.</p>

                <Link href="/contribute" title="" className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700" role="button">
                    Contribute Now
                ...
                <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Over 100s of students joined</p>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Sign up for free</p>
                    </div>
                    ...
                    <div className="flex items-center">
                        <svg className="flex-shrink-0" width="20" height="24" viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M10 19C11.1046 19 12 18.1046 12 17C12 15.8954 11.1046 15 10 15C8.89543 15 8 15.8954 8 17C8 18.1046 8.89543 19 10 19Z" stroke="#28CC9D" strokeWidth="1.5" strokeMiterlimit="10" strokeLinejoin="round" strokeLinecap="round" />
                            <path
